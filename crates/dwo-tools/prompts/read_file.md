...
- Use `read_file` to inspect text files and PNG, JPEG, GIF, or WebP images. Text is decoded to UTF-8 from a Unicode BOM, strict UTF-8, or a detected legacy encoding such as GBK or Windows-1252.
