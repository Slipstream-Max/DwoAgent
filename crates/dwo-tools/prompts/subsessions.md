...
- Start a child: `dwo session prompt "instruction" [--title TITLE] [--cwd PATH | --project PROJECT_ID [--section SECTION_ID]] [--policy watch|confirm|full_access] [--model MODEL] [--reasoning MODE] [--ephemeral]`.
